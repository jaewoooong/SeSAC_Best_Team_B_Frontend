...
const Aside: React.FC = () => {
  const [isUploadComponentVisible, setIsUploadComponentVisible] = useState<boolean>(false);
  ...
  return  (
    <>
      <aside className="aside1" style={{ display: isAsideVisible ? 'flex' : 'none' }} >
          <div>
            <Link to="/">
            ...
            <div 
              style={{width:"80%", textAlign:"center", color:"#fff", marginTop:"100px",margin:"20px 10%", background: "rgb(255 255 255 / 15%)", padding:"7px 0", borderRadius:"15px 25px 15px 25px"}} 
